...
- **Norwegian, Dutch and Swedish translation catalogues** (TWO-24760)
  ...
  - **No migration and no new upgrade script**: three new translation catalogues and nothing else. No configuration key, no database column, no request shape change
