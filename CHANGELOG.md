...
- **The company field now says what it wants, before and below the search threshold** (TWO-25288, umbrella TWO-24739)
  ...
  - **No migration and no new upgrade script**: browser JS, one address-form placeholder, two translatable strings and tests. No configuration key, no database column, no template change, and no change to any request shape
